...
constexpr S PIECE_SQUARE_TABLES[6][64] = {
    ...
    { // Knight
        S(-72,-49),S(-54,-42),S(-42,-26),S(-36, -8),S(-36, -8),S(-42,-26),S(-54,-42),S(-72,-49),
        S(-44,-34),S(-22,-26),S(-10,-10),S( -4,  7),S( -4,  7),S(-10,-10),S(-22,-26),S(-44,-34),
        S(-34,-26),S(-12,-19),S(  0, -3),S(  6, 15),S(  6, 15),S(  0, -3),S(-12,-19),S(-34,-26),
        S(-14,-21),S(  8,-14),S( 20,  2),S( 26, 20),S( 26, 20),S( 20,  2),S(  8,-14),S(-14,-21),
        S(-15,-21),S(  8,-14),S( 20,  2),S( 26, 20),S( 26, 20),S( 20,  2),S(  8,-14),S(-15,-21),
        S( -5,-26),S( 18,-19),S( 30, -3),S( 36, 15),S( 36, 15),S( 30, -3),S( 18,-19),S( -5,-26),
        S(-32,-34),S(-10,-26),S(  2,-10),S(  8,  7),S(  8,  7),S(  2,-10),S(-10,-26),S(-32,-34),
        S(-90,-49),S(-32,-42),S(-20,-26),S(-14, -8),S(-14, -8),S(-20,-26),S(-32,-42),S(-90,-49)
    },
    { // Bishop
        S(-27,-32),S(-14,-21),S(-17,-22),S(-22,-13),S(-22,-13),S(-17,-22),S(-14,-21),S(-27,-32),
        S(-14,-22),S(  4,-10),S(  0,-11),S( -4, -2),S( -4, -2),S(  0,-11),S(  4,-10),S(-14,-22),
        S(-10,-16),S(  8, -5),S(  5, -6),S(  0,  3),S(  0,  3),S(  5, -6),S(  8, -5),S(-10,-16),
        S(-10,-18),S(  9, -6),S(  6, -7),S(  1,  2),S(  1,  2),S(  6, -7),S(  9, -6),S(-10,-18),
        S(-11,-18),S(  8, -6),S(  4, -7),S( -0,  2),S( -0,  2),S(  4, -7),S(  8, -6),S(-11,-18),
        S(-14,-16),S(  4, -5),S(  1, -6),S( -4,  3),S( -4,  3),S(  1, -6),S(  4, -5),S(-14,-16),
        S(-16,-22),S(  2,-10),S( -1,-11),S( -6, -2),S( -6, -2),S( -1,-11),S(  2,-10),S(-16,-22),
        S(-24,-32),S(-11,-21),S(-14,-22),S(-19,-13),S(-19,-13),S(-14,-22),S(-11,-21),S(-24,-32)
    },
    { // Rook
        ...
        S(-11,  2),S( -4,  2),S( -1,  2),S(  1,  2),S(  1,  2),S( -1,  2),S( -4,  2),S(-11,  2),
        S(-11,  2),S( -4,  2),S( -1,  2),S(  1,  2),S(  1,  2),S( -1,  2),S( -4,  2),S(-11,  2),
        S( -6,  2),S(  2,  2),S(  4,  2),S(  7,  2),S(  7,  2),S(  4,  2),S(  2,  2),S( -6,  2),
        S(-11,  2),S( -8,  2),S( -6,  2),S( -4,  2),S( -4,  2),S( -6,  2),S( -8,  2),S(-11,  2)
    },
    { // Queen
    ...
    { // King
        S(149, 14),S(166, 40),S(137, 54),S(112, 58),S(112, 58),S(137, 54),S(166, 40),S(149, 14),
        S(144, 37),S(161, 64),S(131, 78),S(107, 82),S(107, 82),S(131, 78),S(161, 64),S(144, 37),
        S(112, 56),S(129, 82),S(100, 96),S( 76,100),S( 76,100),S(100, 96),S(129, 82),S(112, 56),
        S( 98, 68),S(115, 94),S( 86,108),S( 62,112),S( 62,112),S( 86,108),S(115, 94),S( 98, 68),
        S( 87, 68),S(104, 94),S( 74,108),S( 50,112),S( 50,112),S( 74,108),S(104, 94),S( 87, 68),
        S( 73, 56),S( 90, 82),S( 60, 96),S( 36,100),S( 36,100),S( 60, 96),S( 90, 82),S( 73, 56),
        S( 60, 37),S( 76, 64),S( 47, 78),S( 23, 82),S( 23, 82),S( 47, 78),S( 76, 64),S( 60, 37),
        S( 49, 14),S( 66, 40),S( 37, 54),S( 12, 58),S( 12, 58),S( 37, 54),S( 66, 40),S( 49, 14)
    }
};
